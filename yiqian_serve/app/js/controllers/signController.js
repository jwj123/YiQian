...
function SignCtrl ($scope, $http, $modal,constantIP){
    console.log("加载签到情况..."+constantIP);
    ...
    $scope.getPagedDataAsync = function (pageSize, page, searchText) {
        ...
        $http({
            method: 'POST',
            url: 'http://'+constantIP+':8080/ssh/calltherollaction/getAllCallTheRollHql'
