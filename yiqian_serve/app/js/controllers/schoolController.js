...
function SchoolCtrl ($scope, $http, $modal,constantIP){
    ...
    $scope.getPagedDataAsync = function (pageSize, page, searchText) {
        $http({
            method: 'POST',
            url: 'http://'+constantIP+':8080/ssh/schoolInfoaction/getSchoolInfo'
    ...
    $scope.insert = function(){
        $modal.open({
            templateUrl: "/templates/school/schoolModel.html",
    ...
    $scope.delete = function(){
        ...
        $http({
            method: 'POST',
            url: 'http://'+constantIP+':8080/ssh/schoolInfoaction/deleteSchoolInfo',
            params: {
                "school": json
            }
...
function SchoolInfoInsertCtrl($scope, $modalInstance, $http, grid,constantIP){
    ...
    $scope.ok = function () {
        $http({
            method: 'POST',/*-GET--*/
            url: 'http://'+constantIP+':8080/ssh/schoolInfoaction/createSchoolInfo',
            data:{
...
function SchoolInfoUpdateCtrl($scope, $modalInstance, $http, grid,$log,constantIP){
    ...
    $scope.ok = function () {
        $http({
            method: 'POST',
            url: 'http://'+constantIP+':8080/ssh/schoolInfoaction/updateSchoolInfo',
            data: {
                "school": $scope.SchoolInfos.school,
                "college": $scope.SchoolInfos.college,
                "department":$scope.SchoolInfos.department
