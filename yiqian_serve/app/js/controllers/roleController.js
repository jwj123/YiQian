...
function RoleCtrl ($scope, $http, $modal,constantIP){
    ...
    $scope.insert = function(){
        $modal.open({
            templateUrl: "/templates/role/roleModel.html",
    ...
    $scope.delete = function(){
        ...
        $http({
            method: 'POST',
            url: 'http://'+constantIP+':8080/ssh/ddRoleaction/deleteDdRoleByName',
            params: {
                "dname": json
            }
...
function RoleInsertCtrl1($scope, $modalInstance, $http, grid,constantIP){
    ...
    $scope.ok = function () {
        $http({
            method: 'POST',/*-GET--*/
            url: 'http://'+constantIP+':8080/ssh/ddRoleaction/createDdRole',
            data:{
...
function RoleUpdateCtrl1($scope, $modalInstance, $http, grid, $log, constantIP){
    ...
    $http({
        method: 'GET',
        url: 'http://'+constantIP+':8080/ssh/ddRoleaction/getDdRoleStateByName',
    ...
    $scope.ok = function () {
        $http({
            method: 'POST',
            url: 'http://'+constantIP+':8080/ssh/ddRoleaction/updateDdRoleStateByName',
            data: {
                "oldname":oldrolename,
                "dname": $scope.roles.dname,
                "role": $scope.roles.role
