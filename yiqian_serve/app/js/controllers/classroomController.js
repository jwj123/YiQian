...
function ClassroomCtrl ($scope, $http, $modal,constantIP){
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [
            ...
            {field:'university', displayName:'学校'},
            {field:'building', displayName:'教学楼'},
            {field:'classroom', displayName:'教室'}
        ]
    };
    ...
    $scope.insert = function(){
        $modal.open({
            templateUrl: "/templates/classroom/classroomModel.html",
