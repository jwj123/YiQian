...
function StateCtrl ($scope, $http, $modal,constantIP){
    ...
    $scope.getPagedDataAsync = function (pageSize, page, searchText) {
        $http({
            method: 'POST',
            url: 'http://'+constantIP+':8080/ssh/ddStateaction/getAllDdState'
    ...
    $scope.insert = function(){
        $modal.open({
            templateUrl: "/templates/state/stateModel.html",
    ...
    $scope.delete = function(){
        ...
        $http({
            method: 'POST',
            url: 'http://'+constantIP+':8080/ssh/ddStateaction/deleteDdStateByName',
            params: {
                "dname": json
            }
...
function StateInsertCtrl($scope, $modalInstance, $http, grid,constantIP){
    ...
    $scope.ok = function () {
        $http({
            method: 'POST',/*-GET--*/
            url: 'http://'+constantIP+':8080/ssh/ddStateaction/createDdState',
            data:{
...
function StateUpdateCtrl($scope, $modalInstance, $http, grid,$log,constantIP){
    ...
    $http({
        method: 'GET',
        url: 'http://'+constantIP+':8080/ssh/ddStateaction/getDdStateStateByName',
    ...
    $scope.ok = function () {
        $http({
            method: 'POST',
            url: 'http://'+constantIP+':8080/ssh/ddStateaction/updateDdStateStateByName',
            data: {
