...
function CategoryCtrl ($scope, $http, $modal,constantIP){
    console.log("加载用户类别..."+constantIP);
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [
            ...
            {field:'Category', displayName:'用户类别'},
            {field:'CategoryID', displayName:'类别编号'},
            {field:'CategoryNote', displayName:'备注'}
        ]
    };
    ...
    $scope.insert = function(){
        $modal.open({
            templateUrl: "/templates/category/categoryModel.html",
